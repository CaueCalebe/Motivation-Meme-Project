...
<h1 align="center"> 
	  🚀✅ {Motivation-Meme-Project} - Concluído ✅🚀
</h1>
...
- assets (Pasta que armazena imagens)
...
{Motivation-Meme-Project} foi um projeto criado durante o curso Developer Full-Stack da Angela na plataforma da Udemy.

O desafio proposto para este projeto era a criação de um meme, utilizando tags simples do css como:

background-color, text-align, color, border, margin, width...
...
- [x] Apresentar a imagem estilizada com uma frase relacionada a ela.
